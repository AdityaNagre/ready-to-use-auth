    ...
    <div>
        <section className="text-gray-600 body-font mt-20">
            ...
            <div className='flex justify-between mb-5'>
                ...
                <button onClick={LogOut} className="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Log Out</button>
                </div>
                <div className="flex flex-wrap -m-4">
                <div className="p-4 lg:w-1/3">
                    <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                    <h2 className="trackingWidest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY</h2>
